...
Next I'm going to create 3 public subnets and 3 private subnets. Hence I'm going to divide the entire IP range into 8 equal subnets (/19). For this, I'm using the [cidrsubnet function](https://www.terraform.io/docs/language/functions/cidrsubnet.html) in terraform.
